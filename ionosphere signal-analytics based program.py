...
# Читаем, парсим, базовая процедура
...
# Тут происходит следующее: такт записи амплитуды - переменная, линейно зависящая от номера секунды
...
# учитывающий смещение в показателе десятки на -6, что соответствует истинным значениям амплитуд и моему зрению
